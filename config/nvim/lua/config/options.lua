local options = {
    ...
    clipboard = "", -- don't let neovim to access the system clipboard
    ...
    softtabstop = 4, -- tab counts for 4 space
...
for theOption, theValue in pairs(options) do
    vim.opt[theOption] = theValue
end
